...
module.exports = (sequelize, DataTypes) => {
  class PPC extends Model {
    ...
    pressAllocationRefId: number;
    plannedQty: number;
    plannedInternalAlloy: string;
    plannedNoOfBilletAndLength: string;
    productionRateRequired: number;
    plannedQuenching: string;
    frontEndCoringLength: number;
    backEndCoringLength: number;
    plantExtrusionLength: number;
    extrusionLengthRefId: number;
    plannedButtThickness: number;
    cutBilletsRefId: number;
    buttWeightPerInch: number;
    // priorityAssignmentRefId: number;
    remarks: string;
    isActive: number;
